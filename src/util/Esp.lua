...
local function createDrawingComponents(dataColor, dataName)
    return {
        ...
        Box = newDrawing("Square", { Thickness = 1, Color = dataColor, Transparency = 1, Filled = false, Visible = false }),
        ...
        Name = newDrawing("Text", { Text = dataName, Color = dataColor, Center = true, Outline = true, Size = ESP.TextSize, Font = ESP.TextFont, Visible = false }),
        Dist = newDrawing("Text", { Text = "", Color = dataColor, Center = true, Outline = true, Size = ESP.TextSize, Font = ESP.TextFont, Visible = false }),
        Tracer = newDrawing("Line", { From = Vector2.new(0, 0), To = Vector2.new(0, 0), Color = dataColor, Thickness = 1, Transparency = 1, Visible = false }),
    }
end
