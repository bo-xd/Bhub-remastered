...
function Pathfinding:FindPath(startObj, goalObj, opts)
	...
	local ok, err = pcall(function()
		...
		if opts.AgentRadius ~= nil then
			params.AgentRadius = opts.AgentRadius
		end
		if opts.AgentHeight ~= nil then
			params.AgentHeight = opts.AgentHeight
		end
		if opts.AgentCanJump ~= nil then
			params.AgentCanJump = opts.AgentCanJump
		end
		if opts.AgentJumpHeight ~= nil then
			params.AgentJumpHeight = opts.AgentJumpHeight
		end
		if opts.AgentMaxSlope ~= nil then
			params.AgentMaxSlope = opts.AgentMaxSlope
		end
